...
import { LayoutDashboard, MessageSquare, Calendar as CalendarIcon, Mail, Users, BookOpen, HeartPulse, Sparkles, Moon, Sun, LogOut } from "lucide-react";
...
const nav = [
  ...
  { to: "/followups", label: "Follow-Ups", icon: HeartPulse },
] as const;
