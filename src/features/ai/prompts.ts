...
Google Calendar is CONNECTED and active. Use calendar tools (\`calendar_list\`, \`calendar_create\`, \`calendar_update\`, \`calendar_delete\`, \`calendar_free_time\`, \`calendar_conflicts\`) whenever the user asks about schedules, meetings, or availability.
`.trim();
...
Respond with 3-5 short, impactful markdown bullets:
